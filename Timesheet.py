...
# # from openpyxl.styles import Protection, Alignment, Font, PatternFill
# # from openpyxl.worksheet.protection import SheetProtection
# # from openpyxl.styles import Protection, Alignment, Font, PatternFill
# # from openpyxl.formatting.rule import FormulaRule
# # from openpyxl.worksheet.datavalidation import DataValidation
...
# #         remark_cell.alignment = Alignment(wrap_text=True, vertical="center", horizontal="left") 
# #         # if remark == "":
# #         #     # No system-generated remark (correction/cap message) — use a
# #         #     # LIVE FORMULA so the placeholder appears/disappears automatically
# #         #     # the instant the employee changes Work From to/from WFH.
# #         #     remark_cell = ws.cell(
# #         #         row=row, column=8,
# #         #         value=f'=IF($F{row}="WFH","Reason mandatory","")'
# #         #     )
# #         # else:
# #         #     # System already generated a real remark (e.g. correction/cap
# #         #     # note) — keep it as static text, don't overwrite with a formula.
# #         #     remark_cell = ws.cell(row=row, column=8, value=remark)
# #         # remark_cell.alignment = Alignment(wrap_text=True, vertical="center", horizontal="left")
# #         if remark == "":
# #             remark_cell = ws.cell(
...
# #         #     if not is_weekend:
# #         #         ws.cell(row=row, column=6, value="On Leave")
# #         #     # weekend + 0 hours -> leave F blank, same as G
# #         # else:
# #         #     ws.cell(row=row, column=6, value=work_from_value)
# #         if hours == 0:
# #             if not is_weekend:
...
# #         else:
# #             if work_from_value == "":
# #                 ws.cell(row=row, column=6, value="Resource to Select")
# #             else:
# #                 ws.cell(row=row, column=6, value=work_from_value)
# #         # if hours != 0 and work_from_value == "":
# #         #     workfrom_mandatory_dv = DataValidation(
# #         #         type="custom",
# #         #         formula1=f'=F{row}<>"Resource to Fill"',
# #         #         allow_blank=False,
# #         #         showErrorMessage=True,
# #         #     )
# #         #     workfrom_mandatory_dv.error = "Please select WFO or WFH for this day."
# #         #     workfrom_mandatory_dv.errorTitle = "Work From required"
# #         #     ws.add_data_validation(workfrom_mandatory_dv)
# #         #     workfrom_mandatory_dv.add(f"F{row}")
        
# #         # Require a Remark whenever Work From = "WFH" for this row
# #         remark_col_letter = "H"
# #         wfh_dv = DataValidation(
# #             type="custom",
# #             formula1=f'=IF($F{row}="WFH",LEN($H{row})>0,TRUE)',
# #             allow_blank=False,
# #             showErrorMessage=True,
# #         )
# #         wfh_dv.error = "Please enter a Remark explaining why you worked from home (WFH)."
# #         wfh_dv.errorTitle = "Remark required for WFH"
# #         ws.add_data_validation(wfh_dv)
# #         wfh_dv.add(f"H{row}")
        
# #         # activity_cell = ws.cell(row=row, column=4, value="Resource to Fill")
# #         # activity_cell.alignment = Alignment(horizontal="center", vertical="center")
# #         # if hours != 0:
# #         if hours != 0 or not is_weekend:
# #             activity_cell = ws.cell(row=row, column=4, value="Resource to Fill")
# #             activity_cell.alignment = Alignment(horizontal="center", vertical="center")
# #         # weekends / 0-hour days -> Activity stays blank, no placeholder
# #         # activity_cell = ws.cell(row=row, column=4, value="Resource to Fill")
# #         # activity_cell.alignment = Alignment(horizontal="center", vertical="center")

# #         activity_dv = DataValidation(
# #             type="custom",
# #             formula1=f'=D{row}<>"Resource to Fill"',
# #             allow_blank=False,
# #             showErrorMessage=True,
# #         )
# #         activity_dv.error = "Please enter your Activity for this day."
# #         activity_dv.errorTitle = "Activity required"
# #         ws.add_data_validation(activity_dv)
# #         activity_dv.add(f"D{row}")
# #     activity_range = f"D14:D{13 + days_in_month}"
# #     placeholder_style = CFFont(italic=True, color="808080")
# #     ws.conditional_formatting.add(
# #         activity_range,
# #         FormulaRule(formula=['D14="Resource to Fill"'], font=placeholder_style)
# #     )
# #     # remark_range = f"H14:H{13 + days_in_month}"
# #     # ws.conditional_formatting.add(
# #     #     remark_range,
# #     #     FormulaRule(
# #     #         formula=['AND($F14="WFH",LEN($H14)=0)'],
...
# #         formula=['AND($F14="WFH",$H14="Reason mandatory")'],
# #         fill=PatternFill(start_color="FFC7CE", end_color="FFC7CE", fill_type="solid"),
# #         stopIfTrue=False,
# #     )
# #     gray_font_rule = FormulaRule(
# #         formula=['$H14="Reason mandatory"'],
# #         font=Font(italic=True, color="808080"),
# #         stopIfTrue=False,
# #     )
# #     ws.conditional_formatting.add(remark_range, red_fill_rule)
# #     ws.conditional_formatting.add(remark_range, gray_font_rule)
    
# #     workfrom_range = f"F14:F{13 + days_in_month}"
# #     ws.conditional_formatting.add(
# #         workfrom_range,
# #         FormulaRule(formula=['$F14="Resource to Select"'], font=Font(italic=True, color="808080"))
# #     )
# #     # ws.conditional_formatting.add(remark_range, red_fill_rule)
# #     # ws.conditional_formatting.add(remark_range, gray_font_rule)
...
# #         workfrom_range,
# #         FormulaRule(
# #             formula=['$F14="Resource to Fill"'],
# #             fill=PatternFill(start_color="FFC7CE", end_color="FFC7CE", fill_type="solid"),
# #             stopIfTrue=False,
# #         )
# #     )
# #      # ← AND ADD THE WARNING BANNER BLOCK HERE (or anywhere else in this same post-loop zone)
# #     ws.column_dimensions["d"].width = 22 # wide enough to hold the full warning text

# #     # last_day_row = 13 + days_in_month
# #     last_day_row = 13 + days_in_month
# #     warning_formula = (
# #         f'=IF(COUNTIF(D14:D{last_day_row},"Resource to Fill")'
# #         f'+COUNTIF(F14:F{last_day_row},"Resource to Fill")'
# #         f'+COUNTIF(H14:H{last_day_row},"Reason mandatory")'
# #         f'+IF(C48="Resource to Fill",1,0)>0,'
# #         f'"⚠ required fields(Activity,Work From,WFH Remarks,Month Summary)",'
# #         f'"✅ All required fields completed")'
# #     )
# #     warning_cell = ws.cell(row=12, column=2, value=warning_formula)
# #     warning_cell.font = Font(bold=True, color="C00000", size=11)
...
# #     # ---- Sign-off block ----
# #     # ws["C52"] = emp_name
# #     name_cell = ws.cell(row=52, column=3, value="Resource to Fill")
# #     name_cell.alignment = Alignment(horizontal="left", vertical="center")
# #     ws.conditional_formatting.add(
# #         "C52",
# #         FormulaRule(formula=['C52="Resource to Fill"'], font=Font(italic=True, color="808080"))
# #     )
# #     # ws["F52"] = get_field(res_row, ["Capgemini Resposible", "Capgemini Responsible"])
# #     capgemini_cell = ws.cell(row=52, column=6, value="Resource to Fill")
# #     capgemini_cell.alignment = Alignment(horizontal="left", vertical="center")
# #     ws.conditional_formatting.add(
# #         "F52",
# #         FormulaRule(formula=['F52="Resource to Fill"'], font=Font(italic=True, color="808080"))
# #     )
# #     ws["F56"] = get_field(res_row, ["EGA Resposible", "EGA Responsible"])
# #     # ---- Lock only these specific cells; everything else stays editable ----
# #     # locked_cells = ["D6", "D7", "D8", "D9", "D10", "D11"]
...
# #     # ws.protection.enable()
# #     # editable_cols = {4, 6}  # column D = Activity, column F = Work From
# #     editable_cols = {4, 6, 7, 8}  # column D = Activity, column F = Work From, column G = Billable Hours
# #     editable_rows = set(range(14, 14 + days_in_month))  # daily table rows only
...
# #         for cell in row:
# #             is_editable = (cell.row in editable_rows) and (cell.column in editable_cols)
# #             if cell.column == 8:  # Remark column — hide formula, keep editable
# #                 cell.protection = Protection(locked=not is_editable, hidden=True)
# #             else:
# #                 cell.protection = Protection(locked=not is_editable)
...
# #             cell.protection = Protection(locked=False)
# #             cell.alignment = Alignment(vertical="top", horizontal="left", wrap_text=True)
# #     month_summary_cell = ws.cell(row=48, column=3, value="Resource to Fill")
# #     ws.conditional_formatting.add(
# #         "C48",
# #         FormulaRule(formula=['C48="Resource to Fill"'], font=Font(italic=True, color="808080"))
# #     )
# #     summary_dv = DataValidation(
# #         type="custom",
# #         formula1='=C48<>"Resource to Fill"',
# #         allow_blank=False,
# #         showErrorMessage=True,
# #     )
# #     summary_dv.error = "Please enter a summary of activities for the month."
# #     summary_dv.errorTitle = "Month summary required"
...
#     # planned_hours_raw = get_field(res_row, ["SOW planned duration hours", "SOW Planned Duration Hours", "Planned Hours"], None)
#     work_from_value = determine_work_from(role)
#     is_onsite_role = "onsite" in str(role).lower()
...
#                 )
#             else:
#                 remark_cell = ws.cell(row=row, column=8, value="")
#         else:
#             remark_cell = ws.cell(row=row, column=8, value=remark)
#         remark_cell.alignment = Alignment(wrap_text=True, vertical="center", horizontal="left")
...
#         remark_col_letter = "H"
#         # Require a Remark whenever Work From = "WFH" for this row —
#         # only for ONSITE employees. Offshore employees never need a reason.
#         if is_onsite_role:
#             wfh_dv = DataValidation(
#                 type="custom",
#                 formula1=f'=IF($F{row}="WFH",LEN($H{row})>0,TRUE)',
...
def fill_timesheet_for_employee(template_bytes, res_row, daily_hours, neg_set, month, year, matched_rep_key, hours_used_so_far=0):
    ...
    warning_formula = (
        ...
        f'+COUNTIF(F14:F{last_day_row},"Resource to Fill")'
        f'+COUNTIF(H14:H{last_day_row},"Reason mandatory")'
        f'+IF(C48="Resource to Fill - monthly summary",1,0)>0,'
        f'"⚠ required fields(Activity,Work From,WFH Remarks,Month Summary)",'
        f'"✅ All required fields completed")'
    )
    warning_cell = ws.cell(row=12, column=2, value=warning_formula)
    ...
    # ws["C52"] = emp_name
    # name_cell = ws.cell(row=52, column=3, value="Resource to Fill")
    name_cell = ws.cell(row=52, column=3, value="Resource to Fill - EGA Project manager name")
    name_cell.alignment = Alignment(horizontal="left", vertical="center")
    ws.conditional_formatting.add(
        "C52",
        FormulaRule(formula=['C52="Resource to Fill - EGA Project manager name"'], font=Font(italic=True, color="808080"))
    )
    # ws["F52"] = get_field(res_row, ["Capgemini Resposible", "Capgemini Responsible"])
    # capgemini_cell = ws.cell(row=52, column=6, value="Resource to Fill")
    capgemini_cell = ws.cell(row=52, column=6, value="Resource to Fill - CG Project manager name")
    capgemini_cell.alignment = Alignment(horizontal="left", vertical="center")
    ws.conditional_formatting.add(
        "F52",
        FormulaRule(formula=['F52="Resource to Fill - CG Project manager name"'], font=Font(italic=True, color="808080"))
    )
    ws["F56"] = get_field(res_row, ["EGA Resposible", "EGA Responsible"])
    # ---- Lock only these specific cells; everything else stays editable ----
    # locked_cells = ["D6", "D7", "D8", "D9", "D10", "D11"]
    ...
    for row in ws["B48:H50"]:
        for cell in row:
            ...
            cell.alignment = Alignment(vertical="top", horizontal="left", wrap_text=True)
    # month_summary_cell = ws.cell(row=48, column=3, value="Resource to Fill")
    month_summary_cell = ws.cell(row=48, column=3, value="Resource to Fill - monthly summary")
    ws.conditional_formatting.add(
        "C48",
        FormulaRule(formula=['C48="Resource to Fill - monthly summary"'], font=Font(italic=True, color="808080"))
    )
    summary_dv = DataValidation(
        type="custom",
        formula1='=C48<>"Resource to Fill - monthly summary"',
        allow_blank=False,
        showErrorMessage=True,
    )
    summary_dv.error = "Please enter a summary of activities for the month."
